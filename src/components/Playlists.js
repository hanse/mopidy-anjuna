...
import { changePlaylist, select } from '../actions/PlaylistActions';
...
export default class Playlists extends Component {
  ...
  onKeyDown(e) {
    switch (e.which) {
      case 38: // UP
        e.preventDefault();
        this.props.dispatch(select(Math.max(0, this.props.selectedPlaylist - 1)));
        break;

      case 40: // DOWN
        e.preventDefault();
        this.props.dispatch(select(Math.min(this.props.playlists.length - 1, this.props.selectedPlaylist + 1)));
        break;
